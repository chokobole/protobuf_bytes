...
BytesMessage = namedtuple("BytesMessage", 'type data')
...
class TestProtobufBytes(unittest.TestCase):
    ...
    def test_sizes(self):
        m = BytesMessage(type=BytesType.BYTES_TYPE_8U_C1, data=self.data)
        b = Bytes(m)
        ...
        m = BytesMessage(type=BytesType.BYTES_TYPE_8U_C3, data=self.data)
        b = Bytes(m)
        ...
        m = BytesMessage(type=BytesType.BYTES_TYPE_16U_C3, data=self.data)
        b = Bytes(m)
